...
#ifndef NS3PENV_SEMAPHORE_H
#define NS3PENV_SEMAPHORE_H
 ...
 */
struct Ns3penvSemaphore {
  explicit Ns3penvSemaphore() = default;
  ...
  static inline uint8_t atomic_cas8(volatile uint8_t *mem, uint8_t with,
                                    uint8_t cmp) {
