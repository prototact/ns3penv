...
{
/**
  * \brief Abstract base class for all spaces

  * A space can be used to define the format of actions and observations.
  * See OpenGymEnv for details.
  */
class OpenGymSpace : public Object
{
  public:
    ...
    /** \brief Get the space description
     *
     * \return The space description.
     */
    virtual ns3penv::SpaceDescription GetSpaceDescription() = 0;
...
/**
 * \brief A discrete space
 *
 * The set of possible values is {0, 1, ..., n-1}
 */
class OpenGymDiscreteSpace : public OpenGymSpace
{
  public:
    ...
    ns3penv::SpaceDescription GetSpaceDescription() override;
